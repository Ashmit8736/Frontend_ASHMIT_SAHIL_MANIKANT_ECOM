...
//     if (!sku || /\s/.test(sku))
//       return "SKU is required (no spaces allowed)";

//     // 🔥 SKU FORMAT CHECK (ADD)
//     if (!SKU_REGEX.test(sku))
//       return "SKU can contain only A-Z, 0-9, - and _";

//     if (!wholesale_price || Number(wholesale_price) <= 0)
//       return "Enter valid wholesale price";

//     if (!wholesale_moq || Number(wholesale_moq) <= 0)
//       return "Enter valid MOQ";
...
//       min_stock &&
//       total_stock &&
//       Number(min_stock) > Number(total_stock)
//     )
//       return "Min stock cannot exceed total stock";
...
//     const err = validateProductStep(3, images, {});
//     if (err) {
//       alert(err);
//       return;
//     }
...
//     images.forEach((img) => img && data.append("image", img));

//     await axios.post(
//       `${API_BASE}/products/${createdProductId}/images`,
//       data,
//       authConfig
//     );
...
//                       if (id === "__add_new__") {
//                         setCustomParentId(level1);   // parent = Level 1
...
//                       // 🔥 ADD NEW NESTED CATEGORY
//                       if (id === "__add_new__") {
//                         setCustomParentId(level2);   // parent = Level 2
//                         setShowCategoryModal(true);
//                         return;
//                       }
...
//                 <button
//                   onClick={() => {
//                     const err = validateProductStep(1, null, {
//                       level1,
//                       level2,
//                     });
...
//                 <input name="min_stock" placeholder="Min Stock" value={formData.min_stock} onChange={handleChange} />
...
//                 <button onClick={uploadImages}>Finish</button>
//               </>
//             )}
...
//                 {/* <p><b>MOQ:</b> {viewProduct.wholesale_moq}</p> */}
//                 <p><b>Unit:</b> {viewProduct.product_unit}</p>

//                 <p>
//                   <b>Stock:</b>{" "}
//                   {viewProduct.remaining_stock}/{viewProduct.total_stock}
//                 </p>

//                 {/* <p><b>GST:</b> {viewProduct.gst_verified}</p>
//                 <p>
//                   <b>Location:</b>{" "}
//                   {viewProduct.city}, {viewProduct.state}, {viewProduct.country}
//                 </p> */}
