...
// import { setCart as setReduxCart, removeItem as removeReduxItem } from "../../store/slices/cartSlice";
...
//     const grandTotal =
//       sellerSubtotal + supplierSubtotal + supplierGST;
...
//   if (!cart.length) return <h2 className={styles.center}>Your cart is empty 🛒</h2>;
...
//                   {imageUrl ? <img src={imageUrl} /> : <div className={styles.noImage}>No Image</div>}
//                 </div>
...
//                     {item.owner_type === "supplier" ? "Supplier (B2B)" : "Seller (B2C)"}
//                   </span>
...
//                     Subtotal: ₹ {Number(item.item_subtotal).toLocaleString("en-IN")}
//                   </p>
...
//                 }}
//               >
//                 🏭 Supplier items are <strong>self-pickup only</strong>.
//                 No delivery address is required for these items.
//               </p>
//             )}
//             <button
...
//                 <span>₹ {billing?.supplier_subtotal.toLocaleString("en-IN")}</span>
//               </div>
