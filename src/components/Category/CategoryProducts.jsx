...
//                       }
//                     >
//                       {p.source === "supplier" ? "Supplier" : "Seller"}
//                     </span>
      ...
      <div className={styles.main}>
        <div className={styles.productsScroll}>
          ...
          {products.length === 0 ? (
            ...
            <div className={styles.grid}>
              {products.map((p) => {
                // 🔥 STOCK LOGIC — sirf seller pe
                const stock = p.remaining_stock;
                const isOutOfStock = p.product_source === "seller" && stock !== null && stock !== undefined && Number(stock) === 0;
                const isComingSoon = p.product_source === "seller" && (stock === null || stock === undefined);
